...
def load_models(episode):
    policy_net.load_state_dict(torch.load(dirPath + '/SAC_Models/' + world + '/'+str(episode)+ '_policy_net.pth'))
    value_net.load_state_dict(torch.load(dirPath + '/SAC_Models/' + world + '/'+str(episode)+ 'value_net.pth'))
    soft_q_net.load_state_dict(torch.load(dirPath + '/SAC_Models/' + world + '/'+str(episode)+ 'soft_q_net.pth'))
    target_value_net.load_state_dict(torch.load(dirPath + '/SAC_Models/' + world + '/'+str(episode)+ 'target_value_net.pth'))
    print('***Models load***')
