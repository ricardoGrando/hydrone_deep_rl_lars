...
class Respawn():
    def __init__(self):
        ...
        self.modelPath = self.modelPath.replace('hydrone_aerial_underwater_deep_rl/scripts',
                                                'hydrone_aerial_underwater_deep_rl/models/goal_box/model.sdf')
    ...
    def getPosition(self, position_check=False, delete=False):
        ...
        if self.stage != 4:
            while position_check:
                goal_x = random.randrange(0, 45) / 10.0
